...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Netsutra - Change Password</title>
                        ...
                        <div class="card">
                            <div class="card-content">
                              <h3>Change Password</h3><br><br>
                                <div class="row">
                                    <form class="col s12" name="chngpwd" method="post" id="change_pass_form" onSubmit="return validate_pass();">
...
<button type="submit" name="change" class="waves-effect waves-light btn indigo m-b-xs" onclick="return valid();">Change</button>
		...
		$('#change_pass_form').find('input').on('focus', function(){
			...
			function validate_pass(){
				current_pass= $("#password").val();
				current_pass= current_pass.trim();
