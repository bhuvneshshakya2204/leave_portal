...
$sql = "SELECT id FROM tblemployees WHERE Status=1 AND (Dob like '".$today_date."%' OR Dob like '".$today_date_1."%' OR Dob like '".$today_date_2."%' OR Dob like '".$today_date_3."%') OR (AnniversaryDate like '".$today_date."%' OR AnniversaryDate like '".$today_date_1."%' OR AnniversaryDate like '".$today_date_2."%' OR AnniversaryDate like '".$today_date_3."%') OR (JoiningDate like '".$today_date."%' OR JoiningDate like '".$today_date_1."%' OR JoiningDate like '".$today_date_2."%' OR JoiningDate like '".$today_date_3."%') AND id='".$id."'";
$query = $dbh -> prepare($sql);
$query->execute();
if($query->rowCount() > 0) {    
