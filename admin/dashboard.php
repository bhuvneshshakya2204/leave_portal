                        ...
                        <div class="col m3 s12">
                            <div class="card stats-card">
                                <div class="card-content">
                                    ...
                                    $date_object_1 = new DateTime($today_date);
                                    $date_object_1 = $date_object_1->modify('-1 day');
                                    $today_date_1 = $date_object_1->format('j F');
                                    $date_object_2 = $date_object_1->modify('-1 day');
                                    $today_date_2 = $date_object_2->format('j F');
                                    $date_object_3 = $date_object_2->modify('-1 day');
                                    $today_date_3 = $date_object_3->format('j F');
                                    //echo $today_date."===".$today_date_1."====".$today_date_2."====".$today_date_3;
                                    $sql = "SELECT FirstName, LastName, Dob, id, EmailId from tblemployees where Status=1 and (Dob like '" . $today_date . "%' OR Dob like '" . $today_date_1 . "%' OR Dob like '" . $today_date_2 . "%' OR Dob like '" . $today_date_3 . "%')";
                                    $query = $dbh->prepare($sql);
                                    $query->execute();
                        ...
                        <div class="col m3 s12">
                            <div class="card stats-card">
                                <div class="card-content">
                                    ...
                                    <?php
                                    $sql = "SELECT FirstName, LastName, AnniversaryDate, id, EmailId from tblemployees where Status=1 and (AnniversaryDate like '" . $today_date . "%' OR AnniversaryDate like '" . $today_date_1 . "%' OR AnniversaryDate like '" . $today_date_2 . "%' OR AnniversaryDate like '" . $today_date_3 . "%')";
                                    $query = $dbh->prepare($sql);
                                    $query->execute();
                        ...
                        <div class="col m3 s12">
                            <div class="card stats-card">
                                <div class="card-content">
                                    ...
                                    <?php
                                    $sql = "SELECT FirstName, LastName, JoiningDate, id, EmailId from tblemployees where Status=1 and (JoiningDate like '" . $today_date . "%' OR JoiningDate like '" . $today_date_1 . "%' OR JoiningDate like '" . $today_date_2 . "%' OR JoiningDate like '" . $today_date_3 . "%')";
                                    $query = $dbh->prepare($sql);
                                    $query->execute();
