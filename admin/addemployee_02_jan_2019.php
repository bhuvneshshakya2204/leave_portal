...
$co= trim($_POST['co_text']);
$il= trim($_POST['il_text']);
$cl= trim($_POST['cl_text']);
...
$msg_email.= "<tr><td>Your login credentials are as follows:- </td></tr>\r\n";
...
$to_all = trim($to_all, ",");
if($gender == 'Female') { $gender_type="Miss."; } else { $gender_type="Mr."; }
...
$msg_email_all.= "<tr><td><br>You will be glad to know that we are growing in numbers and <strong>".$fullname."</strong> has joined our team on ".$joining."<br>who brings a new lease of energy, experience, and enthusiasm along.</td></tr>\r\n";
$msg_email_all.= "<tr><td><br>He has joined as <strong>".ucwords(htmlentities($designation)).".</strong></td></tr>\r\n";
$msg_email_all.= "<tr><td><br>Let us make him most comfortable and take every measure that he is able to embrace our incredible work culture in the most natural way.</td></tr>\r\n";
$msg_email_all.= "<tr><td><br>Let us all welcome him on board!</td></tr>\r\n";
...
<select  name="designation" autocomplete="off">
    ...
    {   ?>                                            
    <option value="<?php echo htmlentities(strtolower($rs_designation->DesignationType));?>">
        <?php echo htmlentities($rs_designation->DesignationType);?></option>
    <?php }} ?>
</select>
</div>
...
<input id="experience" name="experience" type="text"  value="" autocomplete="off">
</div>
<div class="input-field col m6 s12">
