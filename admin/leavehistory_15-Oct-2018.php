                            ...
                            <div class="card-content">
								...
								<div style="position: absolute; top: 80px; left: 30%; width: 50%; border: 1px solid gray; z-index: 99999; background: #ffffff;">
								  ...
								  <script>
									...
									<div class="input-field col s12">
										<label for="l_from" class="label_up" style="color: black; font-weight: bold;">From</label>
...
<?php 
$eid=$_SESSION['eid'];
$sql = "SELECT id,LeaveType,ToDate,FromDate,Description,PostingDate,AdminRemarkDate,AdminRemark,Status from tblleaves where empid=:eid order by leave_order";
$query = $dbh -> prepare($sql);
