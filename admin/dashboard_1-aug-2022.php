...
?>
                                    ...
                                    <!-- <span class="counter"> --> <!-- comment by vikash --> 
                                    <span class="">
                        ...
                        <div class="card stats-card">
                            <div class="card-content" style="min-height: 120px;">
                                ...
                                <span class="stats-counter" style="font-size: 12px;font-weight: bold;">
                                    <!-- <span class="counter"> -->
                                        <div >
                                            <div class="col s4">IL</div>
                                            <div class="col s4">CL</div>
                                            <div class="col s4">CO</div>
                                        </div>
                                        <div>
                                            <div class="col s4"><?php echo $totalIL ?></div>
                                            <div class="col s4"><?php echo $totalCL ?></div>
                                            <div class="col s4"><?php echo $totalCO ?></div>
                                        </div>
                                </span>                       
