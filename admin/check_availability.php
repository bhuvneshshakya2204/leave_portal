...
// code for emailid personal availablity
if(!empty($_POST["emailid_pers"])) {
$email_pers= $_POST["emailid_pers"];
$sql ="SELECT email_pers FROM tblemployees WHERE email_pers=:email_pers";
$query= $dbh -> prepare($sql);
