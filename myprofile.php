...
<input id="middle_name" name="MiddleName" value="<?php echo htmlentities($result->MiddleName);?>"  type="text" readonly>
</div>
...
<input id="birthdate" name="dob"  class="datepicker1" value="<?php echo htmlentities($result->Dob);?>" readonly>
</div>

<div class="input-field col m3 s12">
	<label for="anniversary" id="anniversary_label" class="label_up">Anniversary</label>
<input id="anniversary" name="anniversary"  class="datepicker1 anniversary_style" value="<?php echo htmlentities($result->AnniversaryDate);?>" <?php if(htmlentities($result->AnniversaryDate)!= "00-00-0000"){ echo "readonly"; } ?>>
</div>
<div class="input-field col m3 s12">
	<label for="designation" id="designation_label" class="label_up">Designation</label>
<input id="designation" name="designation" value="<?php echo ucwords(htmlentities($result->designation));?>" readonly>
</div>
...
<input id="email_pers" name="email_pers" value="<?php echo htmlentities($result->email_pers);?>" readonly>
</div>
<div class="input-field col m3 s12">
...
<input id="emergency" name="emergency" type="tel" value="<?php echo htmlentities($result->emergency_contact);?>" autocomplete="off" required>
 </div>
<div class="input-field col m3 s12">
<label for="joining">Joining Date</label>
<input id="joining" name="joining" type="text" value="<?php echo htmlentities($result->JoiningDate);?>" autocomplete="off" readonly required>
 </div>
 <div class="input-field col m3 s12">
...
<input id="p_address" name="p_address" type="text"  value="<?php echo htmlentities($result->p_address);?>" autocomplete="off" readonly>
</div>
<div class="input-field col s12">
<label for="skill">Skill Set</label>
<input id="skill" name="skill" type="text"  value="<?php echo htmlentities($result->skill_set);?>" autocomplete="off">
 </div>
 <div class="input-field col m3 s12">
<label for="r_manager">Reporting Manager</label>
<?php
$manager_id= $result->reporting_manager;
...
<input id="experience" name="experience" type="text"  value="<?php echo htmlentities($result->previous_exp); ?>" autocomplete="off" <?php if(htmlentities($result->previous_exp)!= NULL && htmlentities($result->previous_exp)!= "NA"){ echo "readonly"; } ?>>
 </div>
 <div class="input-field col m2 s12">
<label for="blood_group">Blood Group</label>
<input id="blood_group" name="blood_group" type="text"  value="<?php echo htmlentities($result->blood_group);?>" autocomplete="off" <?php if(htmlentities($result->blood_group)!= NULL && htmlentities($result->blood_group)!= "NA"){ echo "readonly"; } ?>>
 </div>
  <div class="input-field col m2 s12">
<label for="pan">Pan Card</label>
<input id="pan" name="pan" type="text"  value="<?php echo htmlentities($result->pan);?>" autocomplete="off" <?php if(htmlentities($result->pan)!= NULL && htmlentities($result->pan)!= "NA"){ echo "readonly"; } ?>>
 </div>
  <div class="input-field col m3 s12">
<label for="aadhaar">Aadhaar Card</label>
<input id="aadhaar" name="aadhaar" type="text"  value="<?php echo htmlentities($result->aadhaar);?>" autocomplete="off" <?php if(htmlentities($result->aadhaar)!= NULL && htmlentities($result->aadhaar)!= "NA"){ echo "readonly"; } ?>>
 </div>
