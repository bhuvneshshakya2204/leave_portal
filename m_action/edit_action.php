...
.succWrap{
	...
	$description= "";
		...
		if($query->rowCount() > 0 && ($status== "approved_ok" || $status== "disapproved_not_ok")){
				...
				if($result_check['status']== "edit and leave approved" && $status== "approved_ok"){
					$msg= "Edit request and leave both are already approved";
				}else if($result_check['status']== "edit disapproved" && $status== "disapproved_not_ok"){
					...
					$created_at= date("d-m-Y H:i:s");
						...
						if($lastInsertId){
                            ...
                            $email_body.= "<strong>$email_content $l_type has been $status_inword.</strong><br><br>\r\n";
