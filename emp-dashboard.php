...
?>
    ...
    <body oncontextmenu="return false">
                    ...
                    <div class="col m3 s12">
                        <div class="card stats-card">
                            <div class="card-content" style="min-height: 140px;">
                                ...
                                ?>
                                <div class="stats-counter" style="font-size: 12px;font-weight: bold;width:100%;">
                                    <!-- <span class="counter"> -->
                                    <div>
                                    ...
                                    <!-- <i style="float: right;cursor: pointer;margin-top:5px;"> Show more...</i> -->
                                </div>
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <?php if ($_SESSION['emplogin'] != $emp_record->EmailId) { ?>
        ...
        <!--code for work anniversary model ends-->
